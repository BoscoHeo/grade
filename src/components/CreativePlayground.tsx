...
const CREATIVE_PRESETS: Record<string, ActivityPreset[]> = {
  "자율활동": [
    ...
    },
    {
      topic: "1인 1역 봉사",
      elements: [
        "자신에게 배정된 역할을 묵묵하고 성실하게 끝까지 수행하여 급우들에게 모범이 됨",
        "학급 물품 정돈과 위생 관리 활동에 자발적으로 참여해 쾌적한 교실 환경 구축에 기여함",
        "모두가 꺼리는 일에 솔선수범 나서서 책임을 다하며 학급 구성원의 안전과 편의를 도움",
        "매일 아침 학급 환경 정리를 책임지고 주도하여 급우들의 위생 생활에 긍정적 보탬을 줌"
      ]
    },
    {
      topic: "또래 멘토 상담",
      elements: [
        "학습에 한 발 늦은 급우를 따뜻하고 온화한 태도로 지원하는 지목 멘토 활동을 전개함",
        "급우들의 소소한 어려움을 귀담아듣고 공감하며 갈등을 중재하는 평화 중재자로 활동함",
        "어색한 팀원 간 긍정적인 다리 역할을 도맡아 정서적 안정과 소통의 기회를 제공함",
        "자신의 지식이나 배움의 결실을 급우들과 나눔으로써 더불어 살아가는 공동체 의식을 행동화함"
      ]
    },
    {
      topic: "폭력 예방 캠페인",
  ...
  "진로활동": [
    ...
    },
    {
      ...
      elements: [
        ...
        "급우들과 미래 성장계획 연동 워크숍을 자영 전개해 든든하게 격려하는 서사 교류 시간을 주도함"
      ]
    },
    {
      topic: "기업가정신 모의",
